...
st.markdown("<h1 style='text-align: center; color: white;'> Cricket Data Analysis  </h1>", unsafe_allow_html=True)
...
st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://images.pexels.com/photos/15862398/pexels-photo-15862398/free-photo-of-fans-with-flag-of-india-in-the-stands-of-the-melbourne-cricket-ground.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1");
...
with st.expander("Description"):
    st.info("""This is Project of BE-EXCS-23 \n It's an ML Model to predict IPL Scores between teams in an ongoing match. To make sure the model results accurate score and some reliability the minimum no. of current overs considered is greater than 5 overs.
