...
st.markdown(
    ...
    <style>
    .stApp {{
        background-image: url("https://c0.wallpaperflare.com/preview/16/651/682/ball-baseball-baseball-bat-bat.jpg");
...
if st.button('Predict Score'):
    ...
    # Display the predicted Score Range with custom background color
